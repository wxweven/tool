      ...
      <CardContent className="pt-8 pb-8">
        <div className="max-w-xl mx-auto">
          <Tabs defaultValue="loan-info" className="w-full">
            ...
            <TabsContent value="loan-info" className="space-y-8">
              ...
              <Button onClick={handleCalculate} className="w-full mt-6">计算</Button>
              {hasCalculated && (
              ...
              {hasCalculated && (
                <div className="overflow-x-auto mt-4">
                  <Table>
                    ...
                    <TableBody>
                      {(showAllSchedule ? paymentSchedule : paymentSchedule.slice(0, 12)).map((payment) => (
                      ...
                      {paymentSchedule.length > 12 && !showAllSchedule && (
                        <TableRow>
                          <TableCell colSpan={5} className="text-center text-muted-foreground">
                            仅显示前12期，共{paymentSchedule.length}期
                          </TableCell>
                        </TableRow>
                      )}
                    </TableBody>
                  ...
                  {paymentSchedule.length > 12 && (
                    <div className="flex justify-center mt-4">
                      <Button variant="outline" size="sm" onClick={() => setShowAllSchedule(v => !v)}>
                        {showAllSchedule ? '收起' : '更多'}
                      </Button>
                    </div>
                  )}
                </div>
